    ...
    async.waterfall([
        ...
        function ( cusDatas, cb) {
            async.eachSeries(cusDatas, function(customer, callback) {
                    ...
                    //生成文件
                    self.generateFileByCustomer(customerId, function(err){
                        callback(err);
                    });
            }, function (err) {
                cb(err);
...
LotDetailJob.prototype.generateFileByCustomer = function(customerId, cb){
    var self = this;
    ...
    async.waterfall([
        ...
        //生成每个渠道文件
        function (totalsalemoney, cb) {
            if(totalsalemoney != undefined && totalsalemoney!= null){
                var head = {};
                head.userId = customerId;
                head.gameCode = self.dTerm.gameCode;
                head.termCode = self.dTerm.code;
                head.lotTotalAmount = totalsalemoney;
