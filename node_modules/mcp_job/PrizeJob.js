                        ...
                        if(err){
                           ...
                           if(prizeDate && prizeDate.size != 0){
                               for(var key in prizeDate){
                                  ...
                                  var tempStr = sqlDate.outerId + splitEsp + sqlDate.bonus + splitEsp + sqlDate.bonusBeforeTax + splitEsp + sqlDate.bonusDetail + splitEsp+ sqlDate.bonusStatus + splitEsp + sqlDate.taxStatus;
