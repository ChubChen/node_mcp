                           ...
                           if(prizeDate && prizeDate.size != 0){
                               for(var key in prizeDate){
                                  ...
                                  for(var iterm in bonusDetail){
                                      bonusInfo += gameGrades["lv"+bonusDetail[iterm].level].data.des + "*" + bonusDetail[iterm].count + "注;";
                                  }
                                  var tempStr = sqlDate.outerId + splitEsp + sqlDate.bonus + splitEsp + sqlDate.bonusBeforeTax + splitEsp + bonusInfo + splitEsp+ sqlDate.bonusStatus + splitEsp + sqlDate.taxStatus;
