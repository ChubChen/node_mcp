        ...
        function (callback) {
            hitTable.findAndRemove({}, {}, [], function(err, ticket){
                ...
                if(ticket)
                {
                    ...
                    strB.append(ticket.auditTermCode).append(split).append(ticket.dNumber).append(split).append(ticketStatus.HIT).append(split).append(ticketStatus.customerId);
                    strB.append("\r\n");
                    ...
                    sql += ticket.bonusBeforeTax + ",'" + ticket.auditTermCode + "','" + ticket.dNumber + "'," + ticketStatus.HIT + ",'"+ticket.customerId+"')";
                    //log.info(sql);
                    conn.execute(sql, [], function(err ,data){
                        if(err)
                        {
