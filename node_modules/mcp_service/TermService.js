...
TermService.prototype.findToBackClose = function(cb)
{
    ...
    async.waterfall([
        ...
        function(cb)
        {
            ...
            table.findOne(cond, {gameCode:1, code:1, nextCode:1, closeTime:1, version:1},
            [], function(err, data){
                if(err)
                {
                    cb(err);
...
TermService.prototype.findToCheck = function(cb)
{
    ...
    async.waterfall([
        ...
        function(cb)
        {
            ...
            table.findOne(cond, {wNum:1, gameCode:1, code:1, nextCode:1, closeTime:1, version:1},
            [], function(err, data){
                if(err)
                {
                    cb(err);
        ...
        async.waterfall([
            ...
            function(cb)
            {
                ...
                var cols = {version:1, status:1, gameCode:1, code:1,
                    nextCode:1, openTime:1, closeTime:1, totalsalemoney:1, pool:1, wNum:1};
