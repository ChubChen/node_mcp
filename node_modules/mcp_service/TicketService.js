...
TicketService.prototype.printSuccess = function(ticket, cb)
{
    ...
    async.waterfall([
        ...
        function(backTickt, cb)
        {
            ...
            var maxAwardMoney = ticket.maxAwardMoney != undefined ? ticket.maxAwardMoney : 0;
            var cond = {id:ticket.id, printStatus:ticketPrintStatus.WAITING_PRINT};
            var data = {$set:{printStatus:ticketPrintStatus.PRINT_SUCCESS,
                province:ticket.province, seq:ticket.seq, terminal:ticket.terminal,passw:ticket.passw,maxAwardMoney: maxAwardMoney,
                rNumber:ticket.rNumber,printTime:ticket.printTime,cashTime:ticket.cashTime}};
            backTickt.rNumber = ticket.rNumber;
            backTickt.maxAwardMoney = maxAwardMoney;
            backTickt.printStatus = ticketPrintStatus.PRINT_SUCCESS;
            backTickt.printTime = ticket.printTime;
...
TicketService.prototype.cashBack = function(ticket, cb){
    var self = this;
    async.waterfall([
        //更新数据库状态
        function(cb)
        {
            ...
            var data = {$set:{cashAmount:ticket.cashAmount,cashTerminal:ticket.cashTerminal,cashTime:ticket.cashTime}};
            table.update(cond, data, [], function(err, data){
                cb(err);
            });
        }
