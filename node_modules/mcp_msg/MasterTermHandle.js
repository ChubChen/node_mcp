...
var jcJob = require("mcp_job").JcDrawNumber;
...
MasterTermHandle.prototype.backClose = function(msg, dTerm, cb)
{
    ...
    async.waterfall([
        ...
        function(cb)
        {
            ...
            }else if(dTermGame.type == gameType.Jingcai){
                log.error("竞猜查询" + dTerm);
                jcJob.startJob(dTerm);
                cb(null, null);
            }
            else
            {
...
MasterTermHandle.prototype.check = function(msg, dTerm, cb)
{
    ...
    log.info("check---------------------------");
    log.info(dTerm);
    msgSer.saveTermFileMsg(dTerm, function(err, data){
        cb(err, null);
    });
    /*
