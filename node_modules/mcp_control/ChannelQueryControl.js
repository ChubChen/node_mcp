...
var ChannelQueryControl = function(){
    ...
    self.pTypeToKey = {"01":"hhad", "02":"had", "03":"crs", "04":"ttg", "05":"hafu"}
};
...
ChannelQueryControl.prototype.checkCQ22 = function(user, headNode, bodyNode, cb)
{
    ...
    if(bodyNode.matchCode == undefined || bodyNode.gameCode == null || bodyNode.gameCode == ""){
        delete  bodyNode.matchCode;
    }
    if(bodyNode.pType == undefined || bodyNode.gameCode == null || bodyNode.gameCode == ""){
                    ...
                    if(ticketGame.type == gameType.Jingcai ){
                        ...
                        if(bodyNode.pType){
                            for(var iterm in bodyNode.pType){
                                var key = self.pTypeToKey[bodyNode.pType[iterm]];
                                fields[key] = 1;
                            }
                        }
