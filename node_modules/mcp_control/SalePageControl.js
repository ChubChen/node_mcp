...
SalePageControl.prototype.download = function (headNode, bodyNode, cb) {
    ...
    conf.cols = [{caption:"出票时间",type:'string'},{caption:"彩票Id",type:'string'},{caption:"出票状态",type:'string'},
        {caption:"票状态",type:'string'},{caption:"彩种",type:'string'},{caption:"金额",type:'number'},{caption:"中奖金额",type:'number'}];
    conf.rows = new Array();
        ...
        function (cb) {
            ...
            cursor.toArray(function (err, data) {
                for (var key in data) {
                    ...
                    tempArray.push(set.printStatus.des);
                    tempArray.push(set.status.des);
                    tempArray.push(set.game.name);
