...
var ChannelTradeControl = function(){
    ...
    self.oddsTrans  = {"T51013":"win","T51011":"level","T51010":"lose","T51023":"win","T51021":"level",
                ...
                termTable.findOne(cond, cols ,[] , function(err , data){
                    if(err){
                        ...
                        var pTicket = {_id:ticket.id, gameCode:ticket.gameCode, termCode:ticket.termCode, customerId:ticket.customerId,
                            ...
                            amount:ticket.amount, number:ticket.number, outerId:ticket.outerId, status:ticketStatus.UN_OPEN,presetTerminal:ticket.persetTerminal,
